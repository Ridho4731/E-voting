...
<script type="text/javascript">
    ...
    $query = "SELECT nama, suara FROM mpks"; // select column
    $aresult = $con->query($query);

    ?>

        console.log('ok')
        let vote1 = parseInt(document.getElementById('data1').innerText);
        let vote2 = parseInt(document.getElementById('data2').innerText);
